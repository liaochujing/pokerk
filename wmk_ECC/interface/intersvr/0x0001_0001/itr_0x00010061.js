...
function handle(req, res, body, callback) {
    ...
    if(areas.length > 0){
        db.datadb.cmday.query({$or: areas, time: {$gte: startTime, $lt: endTime}}, {_id: 0, serverNO: 1, classID: 1, id: 1, enUsage: 1, day: 1}, {time: 1}, function (err, results) {
...
module.exports.cmd = cmd.itr_0x00010061;
