...
function handle(req, res, body, callback) {
    ...
    if(areas.length > 0){
        ...
        var get_area_data = function (done) {
            db.datadb.ammon.query({$or: areas, time: {$gte: startTime, $lt: endTime}}, {_id: 0, serverNO: 1, classID: 1, id: 1, month: 1, enUsage: 1, itENUsage: 1/*, ljENUsage: 1, slENUsage: 1, dxENUsage: 1*/}, {time: 1}, function (err, results) {
        ...
        var get_system_group_data = function (done) {
            db.datadb.sgmon.query({$or: areas, time: {$gte: startTime, $lt: endTime}}, {_id: 0, serverNO: 1, classID: 1, id: 1, system: 1, group: 1, month: 1, enUsage: 1}, {time: 1}, function (err, results) {
                if(err) return done(err);
...
module.exports.cmd = cmd.itr_0x00010049;
