...
function handle(req, res, body, callback) {
    dataHelper.send(new DataMessage(CentralCMD.cen_0x00010007, body), function (err, data) {
        if(err) return callback(err);
        callback(null, data);
    })
}

module.exports.cmd = cmd.mgr_0x00000006;
...
module.exports.paramSchema = {
    ...
    properties: {
        ...
        type: {type: 'integer', enum: [0, 1], required: true}
    }
};