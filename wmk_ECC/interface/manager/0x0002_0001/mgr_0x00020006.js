...
function handle(req, res, body, callback) {
    ...
    body.time = new Date();
    dbCDT.upsert_collect_device_type(body.id, body.name, body.desc, body.pointList, body.config, body.data, body.time, function (err) {
        ...
        dbOPL.insert_user_log(ManagerAction.modify_collect_device_type, req.user, '修改采集设备模板:' + body.name, null, new Date());

        callback();
    });
}

module.exports.privilege = privilegePoint.modifyCollectDeviceType;
module.exports.cmd = cmd.mgr_0x00020006;
