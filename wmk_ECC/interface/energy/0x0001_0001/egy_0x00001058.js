...
function handle(req, res, body, callback) {
    ...
    datadb.rmday.query({serverNO: body.serverNO, classID: body.classID, id: body.id, time: {$gte: startTime, $lt: endTime}}, {_id: 0, id: 1, day: 1, cTemp: 1, maxCTemp: 1, minCTemp: 1, hTemp: 1, maxHTemp: 1, minHTemp: 1}, function (err, results) {
...
module.exports.cmd = cmd.cmd_0x00001058;
