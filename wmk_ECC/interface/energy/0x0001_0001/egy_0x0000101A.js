...
function handle(req, res, body, callback) {
    ...
    datadb.rmday.query({serverNO: body.serverNO, classID: body.classID, id: body.id, time: {$gte: startTime, $lt: endTime}}, {_id: 0, day: 1, itENUsage: 1, coldENUsage: 1}, function (err, results) {
...
module.exports.cmd = cmd.cmd_0x0000101A;
