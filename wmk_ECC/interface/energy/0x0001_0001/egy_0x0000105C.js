...
function handle(req, res, body, callback) {
    ...
    datadb.dmday.query({time: {$gte: startTime, $lt: endTime}, $or: idList}, {serverNO: 1, id: 1, day: 1, enUsage: 1}, function (err, results) {
            ...
            if(hvdc){
                ...
                for(var j in dic){
                    ...
                    if(dayItem[hvdc.serverNO]){
                        value = dayItem[hvdc.serverNO][hvdc.id];
                    }
...
module.exports.cmd = cmd.cmd_0x0000105C;
