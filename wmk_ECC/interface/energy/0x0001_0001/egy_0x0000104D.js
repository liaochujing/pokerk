...
function handle(req, res, body, callback) {
    ...
    datadb.rmmon.query(match, {serverNO: 1, id: 1, month: 1, enUsage: 1}, function (err, results) {
        ...
        for(var i=0;i<roomList.length;i++){
            ...
            for(var j in dic){
                ...
                if(monthItem[room.serverNO]){
                    enUsage = monthItem[room.serverNO][room.id];
                }

                roomItem.data.push(enUsage || 0);
            }
...
module.exports.cmd = cmd.cmd_0x0000104D;
