...
function handle(req, res, body, callback) {
    ...
    datadb.rmmon.query(match, {serverNO: 1, classID: 1, id: 1, month: 1, enUsage: 1}, function (err, results) {
        ...
        for(var i=0;i<roomList.length;i++){
            ...
            for(var j in dic){
                ...
                if(monthItem[room.serverNO]){
                    enUsage = monthItem[room.serverNO][room.id] || 0;
                }
...
module.exports.cmd = cmd.cmd_0x00001016;
