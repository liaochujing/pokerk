...
function handle(req, res, body, callback) {
    ...
    datadb.dmmon.query({time: {$gte: startTime, $lt: endTime}, $or: identityList}, {serverNO: 1, id: 1, month: 1, enUsage: 1}, function (err, results) {
...
module.exports.cmd = cmd.cmd_0x0000102B;
