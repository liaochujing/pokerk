...
st.traverseDir(__dirname + '/0x0003_0001/', register_msg_handler);
st.traverseDir(__dirname + '/0x0004_0001/', register_msg_handler);
...
router.use('/api/energy', require('./router/energy'));
