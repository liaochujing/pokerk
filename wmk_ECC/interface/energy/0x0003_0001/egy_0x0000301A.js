...
function handle(req, res, body, callback) {
    ...
    datadb.stmon.query({serverNO: body.serverNO, classID: body.classID, id: body.id, system: body.system, time: {$gte: startTime, $lt: endTime}}, {month: 1, enUsage: 1}, function (err, results) {
...
module.exports.cmd = cmd.cmd_0x0000301A;
