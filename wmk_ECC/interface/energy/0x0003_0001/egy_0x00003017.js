...
function handle(req, res, body, callback) {
    ...
    datadb.ammon.query({serverNO: body.serverNO, classID: body.classID, id: body.id, time: {$gte: startTime, $lt: endTime}}, {month: 1, enUsage: 1}, function (err, results) {
...
module.exports.cmd = cmd.cmd_0x00003017;
